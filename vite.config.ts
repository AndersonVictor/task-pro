  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        short_name: "Task Pro",
        description:
          "   ¡Intenta buscar con diferentes palabras clave.Task Pro con muchas características, incluyendo el almacenamiento local, compartir tareas a través de enlace y mucho más! Hecho por github.com/AndersonVictor",
        name: "Task Pro",
        icons: [
          {
            src: "/logo192.png",
