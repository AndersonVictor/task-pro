...
export const SettingsDialog: React.FC<SettingsProps> = ({ open, onClose }) => {
  ...
  return (
    <Dialog open={open} onClose={onClose}>
      <DialogTitle sx={{ fontWeight: 600 }}>Configuraciones</DialogTitle>
      <Container>
        {/* Select component to choose the emoji style */}
        <FormGroup>
          <FormControl>
            <FormLabel>Configuración de Emoji</FormLabel>
            ...
            <Tooltip title="El selector de emoji sólo mostrará los emojis de uso frecuente">
              <FormGroup>
                <StyledFormLabel
                  ...
                  label="Sencillo Selector de Emoji"
                />
              </FormGroup>
            </Tooltip>
          </FormControl>
          <Tooltip title="Esto eliminará los datos sobre los emojis más utilizados">
            <Button
              color="error"
              onClick={() => {
            ...
            >
              <DeleteRounded /> &nbsp; Borrar datos emoji
            </Button>
          </Tooltip>
        </FormGroup>
        ...
        <FormGroup>
          <FormLabel>Configuración de App</FormLabel>
          <StyledFormLabel
        ...
        <FormGroup>
          <StyledFormLabel
            ...
            label="Mover las tareas realizadas al final"
          />
        </FormGroup>
          ...
          <FormGroup>
            <FormControl>
              ...
              <StyledFormLabel
                ...
                label={`Sólo voces en el idioma local (${
